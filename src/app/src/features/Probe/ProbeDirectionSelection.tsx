...
const ProbeDirectionSelection: React.FC<Props> = ({
    ...
    // Index matches the BL/TL/TR/BR constants in app/lib/Probing: the corner
    // index selects the sign of the 22.5mm plate offset, so these labels must
    // stay in the same order as `probeDirections` there.
    const cornerLabels = [
        'Front-Left corner',
        'Top-Left corner',
        'Top-Right corner',
