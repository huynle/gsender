...
export const FLEXOKI_DARK_THEME = 'Flexoki Dark';
export const TOKYO_NIGHT_THEME = 'Tokyo Night';
export const GRUVBOX_LIGHT_THEME = 'Gruvbox Light';
export const AYU_DARK_THEME = 'Ayu Dark';
export const AYU_LIGHT_THEME = 'Ayu Light';
export const THEMES = {
    DARK_THEME: DARK_THEME,
    LIGHT_THEME: LIGHT_THEME,
    CUST_THEME: CUST_THEME,
    FLEXOKI_DARK_THEME: FLEXOKI_DARK_THEME,
    TOKYO_NIGHT_THEME: TOKYO_NIGHT_THEME,
    GRUVBOX_LIGHT_THEME: GRUVBOX_LIGHT_THEME,
    AYU_DARK_THEME: AYU_DARK_THEME,
    AYU_LIGHT_THEME: AYU_LIGHT_THEME,
};
